  ...
  return (
    <Page>
      <div className="w-full">
        {/* Filters Section */}
        <div className="mb-8 bg-white space-y-6">
          <button className="bg-gray-100 p-3 rounded-lg hover:bg-gray-200 mb-6 flex items-center gap-3 transition duration-200 w-full">
      ...
      <div className="flex gap-8">
        {page === "landing" && (
          <>
            {/* Display the Left Side if the Page is part from Visitor View */}
